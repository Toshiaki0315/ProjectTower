...
const ALWAYS_LIT := ["lobby", "lobby2", "lobby3", "sky_lobby", "stairs", "escalator", "elevator", "express_elevator", "service_elevator", "housekeeping", "recycling", "security", "medical", "subway", "parking", "ramp", "helipad", "garden"]
