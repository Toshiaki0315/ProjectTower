...
# 爆弾が仕掛けられるテナント
const TARGET_TYPES := ["small_office", "office", "large_office", "hotel", "hotel_twin", "hotel_suite", "housing", "restaurant", "fastfood", "shop", "cinema", "observatory", "wedding", "event_hall"]
