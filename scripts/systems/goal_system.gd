...
const GOALS := [
	...
	{"name": "50日目までに★3（人口120・メディカルセンター・ゴミ処理場）", "stars": 3, "day": 50},
	{"name": "90日目までに★4（人口250・地下鉄駅・VIPの宿泊・不満なテナント1割以下）", "stars": 4, "day": 90},
	{"name": "120日目までに資金5,000万Crをためよう", "funds": 50000000, "day": 120},
	{"name": "180日目までに★5（人口500・展望台・結婚式場・不満なテナント2割以下）でタワー完成", "stars": 5, "day": 180},
]
