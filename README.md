...
★2以上のビルには、ときどき（1日3%くらい。事故のあと3日間は起きません）**爆破予告**が届きます。

- 10時にテロリストから電話があり、テナント1棟に爆弾を仕掛けたと**身代金**を要求されます。画面で**支払う／支払わない**を選びます。
  - 身代金は**そのときの資金の2割**（最低300,000Cr）です。資金が足りないと支払えません
  - **支払う**と、爆弾は取り除かれて確実に安全です
  - **支払わない**と、そこから120分以内に警備員が解体できなければ爆発します。選ぶまでは時間は進みません
- 支払わなかった場合、爆弾のマスは赤い枠が点滅し、★を押すと「爆破予告！ 3階 に爆弾（残り95分）」と出ます。一番近い**警備員**が現場へ向かい、10分かけて解体します。成功すればビルは無事です。
