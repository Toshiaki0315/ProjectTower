...
人はビルの**入口**から出入りします。入口はロビーの左端（緑の扉の印）と、地下鉄駅（水色の扉の印）で、近い方が使われます。入口からたどり着けない建物には人が来ません。
...
| ![飲食店](docs/images/buildings/restaurant.png) | 飲食店 | 横3マス | 20万円 | 平日12〜13時に社員が一番近い店で昼食（30分）。売上は1人1,000円 |
...
服の色で種類がわかります。カーソルを人のいるマスに合わせると、下部バーにその人のストレスが出ます。
...
人はエレベーターを待っている間にストレスがたまります（0〜100）。ストレスが高くなると服の色が変わるので、どこで待たされているかが一目でわかります。

| 絵 | ストレス | 気持ち |
|---|---|---|
| ![平常](docs/images/people/stress_low.png) | 0〜39 | 平常（服はその人の種類の色） |
| ![イライラ](docs/images/people/stress_mid.png) | 40〜69 | イライラ（ピンク） |
| ![とても不満](docs/images/people/stress_high.png) | 70〜100 | とても不満（赤） |
...
| 収入 | 支出 |
|---|---|
| オフィスの賃料（1マス1日1万円。休日も入る） | 維持費（エレベーター・カゴ・設備） |
