...
**上の階に建物が残っているマスを撤去したときにも、建物の代わりに空きフロアが残ります**（そうしないと上の部屋が空中に浮いてしまうため）。火事で燃え落ちたときや爆発で吹き飛んだときも同じです。上の階はそのままなので、低い階のテナントだけを入れ替えられます。空きフロアは通り抜けでき、その上から別の建物をそのまま建て直せます。上に何もなくなれば、撤去で更地に戻ります。
