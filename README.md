...
建物はそれぞれ横に何マスかの大きさがあり、クリックしたマスを左端に建ちます。上下の階は、**階段**か**エレベーター**でつながないと行き来できません。
...
人は移動の手間（歩く距離・階段・エレベーターの待ち時間）を比べて、一番楽な経路を選びます。1〜2階の移動なら階段、それより遠い階ならエレベーターを使うことが多くなります。
