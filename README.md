...
**建てられる階の決まり:** 1階はロビー専用で、1階に建てられるのはロビー・階段・エレベーターだけです。地下鉄駅は地下5階より深いところにだけ、スロープは地下1階にだけ、スカイロビーは15階・30階・45階…にだけ建てられます。それ以外の建物は、2階から上か地下に建てます。何階かは、カーソル下のマスの情報（下部バーの右）の先頭に出ます。
